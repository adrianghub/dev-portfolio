    ...
    <section id="my-skills" className="skills">
      ...
      <section className="skills-list">
        ...
        <ul className="skills-list__list">
          ...
          <li className="skills-list__item">Working with API & Axios</li>
          <li className="skills-list__item">Unit Testing - Jest & Enzyme </li>
      ...
      <section className="skills-list skills-list--violet">
        ...
        <ul className="skills-list__list">
          <li className="skills-list__item">Redux & Context API</li>
          <li className="skills-list__item">Web Components</li>
          <li className="skills-list__item">PWA & Web Sockets</li>
      ...
      <section className="skills-list skills-list--blue">
        ...
        <ul className="skills-list__list">
          <li className="skills-list__item">Express</li>
          <li className="skills-list__item">Deno</li>
          <li className="skills-list__item">Flutter</li>
          <li className="skills-list__item">React Native</li>
          <li className="skills-list__item">Material UI</li>
          <li className="skills-list__item">Cypress</li>
          <li className="skills-list__item">GraphQL & Apollo</li>
          <li className="skills-list__item">Next.js</li>
          <li className="skills-list__item">Svelte</li>
